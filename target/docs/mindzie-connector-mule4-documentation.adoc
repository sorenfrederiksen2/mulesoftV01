...
= Mindzie Connector Mule4 Module Connector Reference
...
`<mindzie-connector-mule-4:post-upload-csv-update-log-with-csv-data>`
...
* MINDZIE-CONNECTOR-MULE-4:BAD_REQUEST {nbsp}
* MINDZIE-CONNECTOR-MULE-4:CLIENT_ERROR {nbsp}
* MINDZIE-CONNECTOR-MULE-4:CONNECTIVITY {nbsp}
* MINDZIE-CONNECTOR-MULE-4:INTERNAL_SERVER_ERROR {nbsp}
* MINDZIE-CONNECTOR-MULE-4:NOT_ACCEPTABLE {nbsp}
* MINDZIE-CONNECTOR-MULE-4:NOT_FOUND {nbsp}
* MINDZIE-CONNECTOR-MULE-4:RETRY_EXHAUSTED {nbsp}
* MINDZIE-CONNECTOR-MULE-4:SERVER_ERROR {nbsp}
* MINDZIE-CONNECTOR-MULE-4:SERVICE_UNAVAILABLE {nbsp}
* MINDZIE-CONNECTOR-MULE-4:TIMEOUT {nbsp}
* MINDZIE-CONNECTOR-MULE-4:TOO_MANY_REQUESTS {nbsp}
* MINDZIE-CONNECTOR-MULE-4:UNAUTHORIZED {nbsp}
* MINDZIE-CONNECTOR-MULE-4:UNSUPPORTED_MEDIA_TYPE {nbsp}
