...
= Mindzie Api Module Connector Reference
...
`<mindzie-api:post-upload-csv-update-log-with-csv-data>`
...
* MINDZIE-API:BAD_REQUEST {nbsp}
* MINDZIE-API:CLIENT_ERROR {nbsp}
* MINDZIE-API:CONNECTIVITY {nbsp}
* MINDZIE-API:INTERNAL_SERVER_ERROR {nbsp}
* MINDZIE-API:NOT_ACCEPTABLE {nbsp}
* MINDZIE-API:NOT_FOUND {nbsp}
* MINDZIE-API:RETRY_EXHAUSTED {nbsp}
* MINDZIE-API:SERVER_ERROR {nbsp}
* MINDZIE-API:SERVICE_UNAVAILABLE {nbsp}
* MINDZIE-API:TIMEOUT {nbsp}
* MINDZIE-API:TOO_MANY_REQUESTS {nbsp}
* MINDZIE-API:UNAUTHORIZED {nbsp}
* MINDZIE-API:UNSUPPORTED_MEDIA_TYPE {nbsp}
