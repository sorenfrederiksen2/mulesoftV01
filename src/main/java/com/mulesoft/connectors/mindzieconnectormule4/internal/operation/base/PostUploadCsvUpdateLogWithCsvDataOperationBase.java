package com.mulesoft.connectors.mindzieconnectormule4.internal.operation.base;
...
public abstract class PostUploadCsvUpdateLogWithCsvDataOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/UploadCsv/UpdateLogWithCsvData";
  ...
  public PostUploadCsvUpdateLogWithCsvDataOperationBase() {
    super();
  }

  public PostUploadCsvUpdateLogWithCsvDataOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postUploadCsvUpdateLogWithCsvData(
      RestConfiguration config,
      RestConnection connection,
      String logIdQueryParam,
      String delimiterQueryParam,
      String cultureQueryParam,
      String encodingQueryParam,
    ...
    try {
      ...
      postUploadCsvUpdateLogWithCsvDataMain(
          config,
          connection,
          logIdQueryParam,
          delimiterQueryParam,
  ...
  protected void postUploadCsvUpdateLogWithCsvDataMain(
      RestConfiguration config,
      RestConnection connection,
      String logIdQueryParam,
      String delimiterQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addQueryParam("logId", logIdQueryParam)
            .addQueryParam("delimiter", delimiterQueryParam)
            .addQueryParam("culture", cultureQueryParam)
            .addQueryParam("encoding", encodingQueryParam)
            .setBody(postUploadCsvUpdateLogWithCsvDataBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
